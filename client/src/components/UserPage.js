        ...
        <Paper className={classes.userInfoWrapper} variant='outlined'>
          <div className={classes.avatarWrapper}>
            {avatar && avatar.exists ? (
              <Avatar alt={userName} src={avatar.imageLink} className={classes.avatar} />
            ) : (
          ...
          <div className={classes.rightWrapper}>
            ...
            <div className={classes.itemWrapper}>
              ...
              <div className={classes.twoItemsDiv}>
                <Typography variant='body1' color='secondary'>
                  Post <strong>{karmaPoints.postKarma}</strong>
                </Typography>
                <Typography variant='body1' color='secondary'>
                  Comment <strong>{karmaPoints.commentKarma}</strong>
                </Typography>
              </div>
            </div>
          </div>
